 ...
 * its output
 */
public class TimeoutCommandRunner extends Thread
{
	 ...
	 */
	public TimeoutCommandRunner(List<String> command, String stdin)
	{
		super();
	 ...
	 * of the command being run
	 */
	public TimeoutCommandRunner(String[] command, String stdin)
	{
		super();
		m_command = command;
		m_stdin = stdin;
	 ...
	 * @param command The command to run
	 */
	public TimeoutCommandRunner(String[] command)
	{
		this(command, null);
	}
	...
	{
		TimeoutCommandRunner runner = new TimeoutCommandRunner(command, inputs);
		runner.start();
	...
	public void run()
	{
		...
		try
		{
			...
			ProcessWithTimeout process_t = new ProcessWithTimeout(process);

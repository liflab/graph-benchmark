...
public abstract class CombinatorialTestingProblem 
{
	...
	/**
	 * Creates a new combinatorial testing problem
	 * @param random A random number generator
	 */
	public CombinatorialTestingProblem(Random random)
	{
		super();
		m_random = random;
	}
	 ...
	 * print stream
	 * @param random A LabPal random number generator
	 */
	public abstract void generateFor(String tool_name, PrintStream ps) throws ExperimentException, IOException;
	
	/**
	 * Cleans additional files generated by a problem for a given tool
	 * @param tool_name The name of the tool to clean the files for
	 */
	public abstract void cleanFor(String tool_name);
